        ...
        <div class="invoice-company">
            <div style="display: flex;justify-content: space-between;margin-bottom: -18px;">
                <div>
                    ...
                    <a href="./report_ck5_plb_hal_1A.php?AJU=<?= $_GET['AJU']; ?>" class="btn btn-sm btn-primary m-b-10" title="Update CK5PLB" style="padding: 7px;">
                        <div style="display: flex;justify-content: space-between;align-items: end;">
                            <i class="fas fa-file" style="font-size: 18px;margin-top: -10px;"></i>&nbsp;Hal 1A
                        </div>
                    </a>
                    <a href="./report_ck5_plb_hal_detail_barang.php?AJU=<?= $_GET['AJU']; ?>" class="btn btn-sm btn-default m-b-10" title="Update CK5PLB" style="padding: 7px;">
                        <div style="display: flex;justify-content: space-between;align-items: end;">
                ...
                <div>
                    ...
                    <a href="report_ck5_plb_hal_1A_excel.php" target="_blank" class="btn btn-sm btn-white m-b-10">
                        <img src="assets/img/favicon/excel.png" class="icon-primary-excel" alt="Excel"> Export Excel Hal. 1A
                    </a>
                    <a href="report_ck5_plb_hal_1A_print.php" target="_blank" class="btn btn-sm btn-white m-b-10">
        ...
        <div class="row" style="display: flex;align-items: center;margin-bottom: -5px;">
            ...
            <div class="col-md-9">
                <div style="display: grid;justify-content: left;">
                    <font style="font-size: 24px;font-weight: 800;">LAPORAN BC 2.7 PLB - Halaman 1A</font>
