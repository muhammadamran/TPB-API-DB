...
header("Content-Disposition: attachment; filename=Laporan BC 2.7 PLB-Halaman_Detail_Barang$datenow.xls");
?>
<!-- QUERY -->
<?php
...
tags will be replaced.-->
		...
		<table border=0 cellpadding=0 cellspacing=0 width=1305 style='border-collapse:collapse;table-layout:fixed;width:980pt'>
			...
			<tr height=31 style='height:23.25pt'>
				<td colspan=9 height=31 class=xl8021469 style='height:23.25pt'>
					<div style='display:grid;justify-content: left'>LAPORAN BC 2.7 PLB - Halaman
						Detail Barang<font class="font521469"> </font>
				</td>
			...
			<tr height=20 style='height:15.0pt'>
				<td colspan=9 height=20 class=xl7921469 style='height:15.0pt'><?= $resultHeadSetting['address'] ?>
	</div>
	</td>
	<td class=xl1521469></td>
	<td class=xl1521469></td>
  ...
  width:144pt'>
			...
			<div style='box-sizing: border-box;margin-right:-1px'></div>Kantor
		</td>
	...
	<table border=0 cellpadding=0 cellspacing=0 width=1305 style='border-collapse:collapse;table-layout:fixed;width:980pt'>
		<tr height=20 style='height:15.0pt'>
			<td colspan=9 rowspan=2 height=40 class=xl7621469 style='height:30.0pt'>
				<!-- </div> -->Export
				BC 2.7 PLB | IT Inventory PT. Sarinah
			</td>
			<td class=xl1521469></td>
			<td class=xl1521469></td>
			<td class=xl1521469></td>
  ...
  15.0pt;width:740pt'>
				...
				<script src="assets/plugins/nvd3/build/nv.d3.js">
				</script>
				<script src="assets/plugins/jvectormap-next/jquery-jvectormap.min.js">
				</script>
				<script src="assets/plugins/jvectormap-next/jquery-jvectormap-world-mill.js">
				</script>
				<script src="assets/plugins/bootstrap-calendar/js/bootstrap_calendar.min.js">
				</script>
				...
				<script src="assets/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js">
				</script>
				<script src="assets/plugins/datatables.net-responsive/js/dataTables.responsive.min.js">
				</script>
				<script src="assets/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js">
				</script>
				<script src="assets/plugins/datatables.net-buttons/js/dataTables.buttons.min.js">
				</script>
				<script src="assets/plugins/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js">
				</script>
				<script src="assets/plugins/datatables.net-buttons/js/buttons.colVis.min.js">
				</script>
				<script src="assets/plugins/datatables.net-buttons/js/buttons.flash.min.js">
				</script>
				<script src="assets/plugins/datatables.net-buttons/js/buttons.html5.min.js">
				</script>
				<script src="assets/plugins/datatables.net-buttons/js/buttons.print.min.js">
				</script>
				<script src="assets/plugins/pdfmake/build/pdfmake.min.js">
				</script>
				<script src="assets/plugins/pdfmake/build/vfs_fonts.js">
				</script>
				<script src="assets/plugins/jszip/dist/jszip.min.js">
				</script>
				<script src="assets/js/demo/table-manage-buttons.demo.js">
				</script>
				<script src="assets/js/demo/table-manage-default.demo.js">
				</script>
				<script src="assets/plugins/datatables.net-fixedcolumns/js/dataTables.fixedcolumns.min.js">
				</script>
				<script src="assets/plugins/datatables.net-fixedcolumns-bs4/js/fixedcolumns.bootstrap4.min.js">
				</script>
				<script src="assets/js/demo/table-manage-fixed-columns.demo.js">
				</script>
				<script src="assets/plugins/datatables.net-fixedheader/js/dataTables.fixedheader.min.js">
				</script>
				<script src="assets/plugins/datatables.net-fixedheader-bs4/js/fixedheader.bootstrap4.min.js">
				</script>
				<script src="assets/js/demo/table-manage-fixed-header.demo.js">
				</script>
