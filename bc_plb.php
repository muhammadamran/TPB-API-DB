...
<?php if ($resultHeadSetting['app_name'] == NULL || $resultHeadSetting['company'] == NULL || $resultHeadSetting['title'] == NULL) { ?>
    <title>Dokumen PLB BC App Name | Company </title>
<?php } else { ?>
    <title>Dokumen PLB BC - <?= $resultHeadSetting['app_name'] ?> | <?= $resultHeadSetting['company'] ?> - <?= $resultHeadSetting['title'] ?></title>
<?php } ?>
<!-- begin #content -->
<div id="content" class="content">
    <div class="page-title-css">
        <div>
            <h1 class="page-header-css">
                ...
                <font class="text-page">Dokumen PLB</font>
            </h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index_viewonline.php">Data Online</a></li>
                <li class="breadcrumb-item active">Dokumen PLB <?= $FindBC ?></li>
            </ol>
        </div>
        <div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                <div class="col-md-7 offset-md-3">
                                    ...
                                    <a href="bc_plb.php" type="button" class="btn btn-warning m-r-5">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="ui-icons-1">
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fas fa-info-circle"></i> [Dokumen PLB] <?= $FindBC ?></h4>
                    <?php include "include/panel-row.php"; ?>
                </div>
                <div class="panel-body text-inverse">
                        ...
                        <table id="C_TableDefault_L" class="table table-striped table-bordered table-td-valign-middle">
                            ...
                            <tbody>
                                ...
                                $dataTable = $dbcon->query("SELECT
                                                            ...
                                                            LEFT OUTER JOIN referensi_status AS sts ON sts.KODE_STATUS=hdr.STATUS_PERBAIKAN 
                                                            ...
                                                            LEFT OUTER JOIN referensi_kantor_pabean AS ktr_a ON ktr_a.KODE_KANTOR=hdr.KODE_KANTOR_MUAT
