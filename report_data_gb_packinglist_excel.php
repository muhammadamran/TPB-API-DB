...
header("Content-Disposition: attachment; filename=Laporan Packing List $GB-$datenow.xls");
?>
<?php
// DATE DAFULT
...
<table width="811">
    <tbody>
        <tr>
            <td colspan="9" rowspan="3" width="747"><span style="color: #404040; font-family: Arial Black; font-size: xx-large;">PACKING LIST</span></td>
...
<table style="height: 36px;" width="1548">
    <tbody>
        <tr style="height: 18px;">
            <td style="border-bottom: 1px solid #333;" colspan="10">&nbsp;</td>
        </tr>
        <tr style="height: 18px;">
            <td style="border-style: none; height: 18px; width: 1541px;" colspan="10">&nbsp;</td>
        </tr>
    </tbody>
</table>
<!-- END LINE -->
