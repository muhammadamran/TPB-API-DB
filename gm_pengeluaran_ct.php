...
if (isset($_GET["aksi"]) == 'SubmitCT') {
    ...
    $InputDescription     = $me . " Cek Barang Keluar: ID Barang Keluar" . @$_GET['ID'];
...
if (isset($_POST["Simpan_"])) {
    ...
    $query = $dbcon->query("UPDATE plb_barang SET STATUS_GB='Sesuai',
                                                  ...
                                                  LITER_GB='$A_LITER',
                                                  TOTAL_LITER_AKHIR_GB='$TOTAL_LITER',
    ...
    if ($query) {
        echo "<script>window.location.href='gm_pengeluaran_detail.php?AJU=$NOMOR_AJU&AlertSuccess';</script>";
    } else {
        echo "<script>window.location.href='gm_pengeluaran_ct.php?ID=$ID&AJU=$NOMOR_AJU&Alert=CekBarangMasuk&AlertSimpan=Failed';</script>";
    }
}
...
<?php if ($resultHeadSetting['app_name'] == NULL || $resultHeadSetting['company'] == NULL || $resultHeadSetting['title'] == NULL) { ?>
    <title>Pengecekan Kriteria Botol Gate Out App Name | Company </title>
<?php } else { ?>
    <title>Pengecekan Kriteria Botol Gate Out - <?= $resultHeadSetting['app_name'] ?> | <?= $resultHeadSetting['company'] ?> -
...
<div id="content" class="content">
    <div class="header-page">
        <div class="row">
            <div class="col-sm-8">
                <a href="gm_pengeluaran_detail.php?AJU=<?= $_GET['AJU'] ?>" class="btn btn-dark"><i class="fas fa-caret-square-left"></i> Kembali</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="ui-icons-1">
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fas fa-star"></i> Status Gate Out Kriteria</h4>
