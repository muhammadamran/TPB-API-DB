...
header("Content-Disposition: attachment; filename=Laporan Realisasi Mitra Tahun $WGetTahunAju_$datenow.xls");
?>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="8" width="981" style="font-size: 14px;font-weight: 900;">
                ...
                ?>
                Total <?= $ResultCountData['total_report_all_mitra'] ?> Mitra Tahun <?= $WGetTahunAju ?>
            </td>
            ...
            <thead>
                ...
                <tr>
                    ...
                    <?php if ($JmlCarton == NULL || $JmlCarton == 0) { ?>
                        <th colspan="2" style="text-align: center;background: transparent;">0</th>
                    <?php } else { ?>
