...
if (isset($_POST['Number_'])) {
    ...
    if ($sql) {
        echo "<script>window.location.href='report_ck5_sarinah_packing.php?AJU=$NOAJU_PLB&AlertNumber=true;</script>";
    } else {
        echo "<script>window.location.href='report_ck5_sarinah_packing.php?AJU=$NOAJU_PLB&AlertNumber=false;</script>";
    }
}
// NO BL
if (isset($_POST['NoBL_'])) {
    ...
    if ($sql) {
        echo "<script>window.location.href='report_ck5_sarinah_packing.php?AJU=$NOAJU_PLB&AlertNoBL=true;</script>";
    } else {
        echo "<script>window.location.href='report_ck5_sarinah_packing.php?AJU=$NOAJU_PLB&AlertNoBL=false;</script>";
    }
}
// WEIGHR
if (isset($_POST['Weight_'])) {
    ...
    if ($sql) {
        echo "<script>window.location.href='report_ck5_sarinah_packing.php?AJU=$NOAJU_PLB&AlertOriginal=true;</script>";
    } else {
        echo "<script>window.location.href='report_ck5_sarinah_packing.php?AJU=$NOAJU_PLB&AlertOriginal=false;</script>";
    }
}
// ORIGINAL
        ...
        <div class="row" style="display: flex;align-items: center;margin-bottom: -5px;">
            ...
            <div class="col-md-9">
                <div style="display: grid;">
                    ...
                    <font style="font-size: 12px;font-weight: 800;">BC 2.7 PLB: <?= $resultdataHeader['NOMOR_AJU_PLB']; ?></font>
                    <font style="font-size: 12px;font-weight: 800;">BC 2.7 GB: <?= $resultdataHeader['NOMOR_AJU_GB']; ?></font>
                ...
                <table id="TableData" class="table table-striped table-bordered first" style="width:100%">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th style="text-align:left"><?= Rupiah($resultFooter['c_cif']); ?></th>
                            <th colspan="2" style="text-align:left"></th>
                            <th style="text-align:right"><?= $resultFooter['c_botol_akhir']; ?> Btl(s)</th>
                            <th style="text-align:right"><?= $resultFooter['c_liter_akhir']; ?> Ltr(s)</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
