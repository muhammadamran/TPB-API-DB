...
<div id="header" class="header navbar-default">
    ...
    <div class="navbar-header">
        ...
        <!-- Gate In -->
        <div style="margin-left: 5px;">
            <a href="" class="btn btn-default" data-toggle="popover" data-trigger="hover" data-title="Gate In" data-placement="bottom" data-content="Gate In"><i class="fas fa-door-open"></i> Gate In <span class="badge"><?= $result_in['total_in'] ?></span></a>
        </div>
        <!-- Gate Out -->
        <div style="margin-left: 5px;">
            <a href="" class="btn btn-default" data-toggle="popover" data-trigger="hover" data-title="Gate Out" data-placement="bottom" data-content="Gate Out"><i class="fas fa-door-closed"></i> Gate Out <span class="badge"><?= $result_out['total_out'] ?></span></a>
        </div>
    </div>
    <!-- end navbar-header -->
    <style>
