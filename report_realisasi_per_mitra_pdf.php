...
<?php if ($resultHeadSetting['app_name'] == NULL || $resultHeadSetting['company'] == NULL || $resultHeadSetting['title'] == NULL) { ?>
    <title>Print Laporan Realisasi Mitra App Name | Company </title>
<?php } else { ?>
    <title>Print Laporan Realisasi Mitra - <?= $resultHeadSetting['app_name'] ?> | <?= $resultHeadSetting['company'] ?> -
                ...
                <div class="panel-body text-inverse">
                    ...
                    <div class="invoice-footer">
                        <p class="text-center m-b-5 f-w-600">
                            Laporan Realisasi Mitra TBB <?= $WGetNameMitra ?> Tahun <?= $WGetTahunAju ?> | <?= $resultHeadSetting['app_name'] ?> <?= $resultHeadSetting['company'] ?>
                        </p>
                        <p class="text-center">
