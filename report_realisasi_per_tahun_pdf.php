...
<?php if ($resultHeadSetting['app_name'] == NULL || $resultHeadSetting['company'] == NULL || $resultHeadSetting['title'] == NULL) { ?>
    <title>Print Laporan Realisasi Mitra Tahun <?= $_GET['TahunAju']; ?> App Name | Company </title>
<?php } else { ?>
    <title>Print Laporan Realisasi Mitra Tahun <?= $_GET['TahunAju']; ?> - <?= $resultHeadSetting['app_name'] ?> | <?= $resultHeadSetting['company'] ?> -
            ...
            <div class="panel panel-inverse" data-sortable-id="ui-perusahaan">
                <div class="report-header-realisasi" style="display: flex;justify-content: space-around;align-items: center;">
                    ...
                    <div class="detail-get" style="justify-content: center;text-align: center;align-items: center;display: grid;">
                        ...
                        <font style="font-size: 12px;font-weight: 600;">Tanggal: <?= date_indo(date('Y-m-d'), TRUE) ?></font>
                ...
                <div class="panel-body text-inverse">
                    ...
                    ?>
                            ...
                            <div style="padding: 1px;background: transparent;margin-top: 10px;margin-bottom: 10px"></div>
                        <?php } ?>
                    <?php } else { ?>
                        <table class="table table-striped table-bordetransparent table-td-valign-middle">
                        </table>
                    ...
                    <div class="invoice-footer">
                        <p class="text-center m-b-5 f-w-600">
                            ...
                            ?>
                            Laporan Realisasi Mitra Tahun <?= $WGetTahunAju ?> Total <?= $ResultCountData['total_report_all_mitra'] ?> Mitra | <?= $resultHeadSetting['app_name'] ?> <?= $resultHeadSetting['company'] ?>
                        </p>
                        <p class="text-center">
