...
<?php } else { ?>
    <title>Pelabuhan Dalam Negeri - <?= $resultHeadSetting['app_name'] ?> | <?= $resultHeadSetting['company'] ?> -
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="ui-pelabuhan-dalam-negeri">
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fas fa-info-circle"></i> [Referensi - Edifact] Pelabuhan Dalam Negeri</h4>
