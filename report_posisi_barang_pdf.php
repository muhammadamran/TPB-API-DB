                    ...
                    <table id="C_TableDefault_L" class="table table-striped table-bordered table-td-valign-middle">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th rowspan="2" style="text-align: center;">Spe.<font style="color: #dadddf;">.</font>Lain</th>
                                <th rowspan="2" style="text-align: center;">Jml.<font style="color: #dadddf;">.</font>Satuan</th>
