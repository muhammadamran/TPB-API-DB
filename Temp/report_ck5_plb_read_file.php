...
$cekRespon = $dbcon->query("SELECT NOMOR_AJU FROM plb_header ORDER BY ID DESC LIMIT 1");
$resultcekRespon = mysqli_fetch_array($cekRespon);

$inputNoAJU    = $resultcekRespon['NOMOR_AJU'];
$inputKDRespon = '0';
$inputNoRespon = '0';
$inputck5_plb_submit = date('Y-m-d H:i:s A');

$query .= $dbcon->query("INSERT INTO plb_status
                       (ID,NOMOR_AJU_PLB,KODE_RESPON,NOMOR_RESPON,ck5_plb_submit)
                       VALUES
